...
((select personId from Person where personCode = "YMCA"), (select personId from Person where personCode = "007Y"), 
	(select personId from Person where personCode = "UIMG"), "PT001"),
...
insert into Asset (assetName, assetType, assetCode, apr, quartlydividend ,
